...
# TODO make this a subclass of TeacherCache
...
def _demo_main():
    ...
    print('FD policy envelope for initial state is', [
        ' '.join('(%s)' % p for p in s.to_tup_state())
